...
class Test_Guru:
    ...
    def test_login(self, boot):
        ...
        # Add Assigned Dependents in Dependents Page
        ...
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().dependents_button).click()
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().add_button).click()

        # Fill details in Assigned Dependents Page
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().name_input_box).send_keys(Guru_Data().name)
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().relationship).click()
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().select_relationship).click()
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().specify_relationship_input_box).send_keys(Guru_Data().specify_relationship)
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().date_of_birth_input_box).send_keys(Guru_Data().date_of_birth)
        self.driver.find_element(by=By.XPATH, value=Guru_Locators().save_button).click()
        time.sleep(10)
        print("Successfully fill all details in Assigned Dependents Page")